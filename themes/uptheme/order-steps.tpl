...
<ul class="step clearfix" id="order_step">
	...
	<li class="{if $current_step=='login'}step_current{elseif $current_step=='address'} hidden-xs step_done step_done_last{else}{if $current_step=='payment' || $current_step=='shipping' || $current_step=='address'}hidden-xs step_done{else} hidden-xs step_todo{/if}{/if} second">
	...
	<li class="{if $current_step=='address'}step_current{elseif $current_step=='shipping'} hidden-xs step_done step_done_last{else}{if $current_step=='payment' || $current_step=='shipping'} hidden-xs step_done{else} hidden-xs step_todo{/if}{/if} third">
