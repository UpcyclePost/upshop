...
<div class="login-panel">
    ...
    <h1 class="">{l s='You'}</h1>
        ...
        <h5 style="padding:15px;">{l s='Manage your personal information and purchases.'}</h5>
		<ul class="myaccount-link-list">
			...
			<li><a href="http://{$smarty.server.SERVER_NAME}/profile/messages">
				<i class="fa fa-fw fa-envelope" {if $m_number_messages > 0}style="color:orange;"{/if}></i> <span>Messages {if $m_number_messages > 0}({$m_number_messages}){/if}</span></a></li>
...
<div class="login-panel">
 ...
 <h5 style="padding:15px;">{l s='Manage your shop.'}</h5>
<ul class="myaccount-link-list">
{if $is_seller==1}
	...
	<li class="lnk_wishlist">
		<a title="My orders received" href="{$my_order|addslashes}">
			...
			<span>{l s='My Orders Received' mod='marketplace'}{if $m_number_orders > 0 } <font class="items"> ({$m_number_orders})</font>{/if}</span></a>
	</li>
	<li class="lnk_wishlist">
