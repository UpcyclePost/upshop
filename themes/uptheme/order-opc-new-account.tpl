	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			<div class="box">
				...
				<h4><sup style="color:#f00;">*</sup> {l s='Required field' mod='marketplace'}</h4>
...
-->
				...
				<div id="opc_account_form" class="unvisible">
					...
					<div class="required text form-group">
						<label for="email"><sup style="color:#F00">*</sup>&nbsp;{l s='Email'}</label>
					...
					<div class="required password is_customer_param form-group">
						<label for="passwd"><sup style="color:#F00">*</sup>&nbsp;{l s='Password'}</label>
					...
					<div class="required form-group">
						<label for="firstname"><sup style="color:#F00">*</sup>&nbsp;{l s='First name'}</label>
					...
					<div class="required form-group">
						<label for="lastname"><sup style="color:#F00">*</sup>&nbsp;{l s='Last name'}</label>
...
-->
					...
					{if $field_name eq "company"}
						<div class="text form-group">
							<label for="company">{if in_array($field_name, $required_fields)}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='Company'}</label>
					...
					<div id="vat_number_block" style="display:none;">
						<div class="form-group">
							<label for="vat_number">{if in_array($field_name, $required_fields)}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='VAT number'}</label>
					...
					<div class="required dni form-group">
						<label for="dni"><sup style="color:#F00">*</sup>&nbsp;{l s='Identification number'}</label>
					...
					<div class="required text form-group">
						<label for="address1"><sup style="color:#F00">*</sup>&nbsp;{l s='Address'}</label>
					...
					<div class="text{if !in_array($field_name, $required_fields)} is_customer_param{/if} form-group">
						<label for="address2">{if in_array($field_name, $required_fields)}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='Address (Line 2)'}</label>
					...
					<div class="required postcode text form-group">
						<label for="postcode"><sup style="color:#F00">*</sup>&nbsp;{l s='Zip/Postal code'}</label>
					...
					<div class="required text form-group">
						<label for="city"><sup style="color:#F00">*</sup>&nbsp;{l s='City'}</label>
					...
					<div class="required select form-group">
						<label for="id_country"><sup style="color:#F00">*</sup>&nbsp;{l s='Country'}</label>
					...
					<div class="required id_state form-group" style="display:none;">
						<label for="id_state"><sup style="color:#F00">*</sup>&nbsp;{l s='State'}</label>
					...
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						<label for="phone_mobile">{if isset($one_phone_at_least) && $one_phone_at_least}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='Mobile phone'}</label>
					...
					<div id="opc_invoice_address" class="is_customer_param">
						...
						{if $field_name eq "company"}
						<div class="form-group">
							<label for="company_invoice">{if in_array($field_name, $required_fields)}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='Company'}</label>
						...
						<div id="vat_number_block_invoice" class="is_customer_param" style="display:none;">
							<div class="form-group">
								<label for="vat_number_invoice">{if in_array($field_name, $required_fields)}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='VAT number'}</label>
						...
						{elseif $field_name eq "firstname"}
						<div class="required form-group">
							<label for="firstname_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='First name'}</label>
						...
						{elseif $field_name eq "lastname"}
						<div class="required form-group">
							<label for="lastname_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='Last name'}</label>
						...
						{elseif $field_name eq "address1"}
						<div class="required form-group">
							<label for="address1_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='Address'}</label>
						...
						<div class="form-group{if !in_array($field_name, $required_fields)} is_customer_param{/if}">
							<label for="address2_invoice">{if in_array($field_name, $required_fields)}<sup style="color:#F00">*</sup>&nbsp;{/if}{l s='Address (Line 2)'}</label>
						...
						<div class="required postcode_invoice form-group">
							<label for="postcode_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='Zip/Postal Code'}</label>
						...
						{elseif $field_name eq "city"}
						<div class="required form-group">
							<label for="city_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='City'}</label>
						...
						{elseif $field_name eq "country" || $field_name eq "Country:name"}
						<div class="required form-group">
							<label for="id_country_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='Country'}</label>
						...
						<div class="required id_state_invoice form-group" style="display:none;">
							<label for="id_state_invoice"><sup style="color:#F00">*</sup>&nbsp;{l s='State'}</label>
