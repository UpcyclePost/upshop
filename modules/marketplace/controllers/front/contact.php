    ...
    public function initContent()
    {
        ...
        if ($id_product != '') {
            ...
            if ($seller_shop_detail) {
                ...
                $this->context->smarty->assign("cont_border_color", $cont_border_color);
                $this->context->smarty->assign("cont_head_info_size", $cont_head_info_size);
                $this->context->smarty->assign("cont_head_info_color", $cont_head_info_color);
                $this->context->smarty->assign("cont_head_info_font_family", $cont_head_info_font_family);
                ...
                $this->context->smarty->assign("cont_heading_size", $cont_heading_size);
                $this->context->smarty->assign("cont_heading_color", $cont_heading_color);
                $this->context->smarty->assign("cont_heading_font_family", $cont_heading_font_family);
                ...
                $this->context->smarty->assign("cont_head_size", $cont_head_size);
                $this->context->smarty->assign("cont_head_color", $cont_head_color);
                $this->context->smarty->assign("cont_head_font_family", $cont_head_font_family);
                $this->context->smarty->assign("cont_size", $cont_size);
                $this->context->smarty->assign("cont_color", $cont_color);
                $this->context->smarty->assign("cont_font_family", $cont_font_family);
