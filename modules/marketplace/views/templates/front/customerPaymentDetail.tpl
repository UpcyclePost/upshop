<div style="height:650px;margin-left:60px;">
	<form action="{$payPro_link|escape:'html':'UTF-8'}" method="post" class="std" enctype="multipart/form-data" accept-charset="UTF-8,ISO-8859-1,UTF-16">
		<fieldset id="addproduct_fieldset">
			...
			<p class="text">
				...
				<span><input type="hidden" id="customer_id" name="customer_id" value="{$customer_id|escape:'html':'UTF-8'}" class="account_input"/></span>
			</p>
