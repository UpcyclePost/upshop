	...
	<div class="dropdown-menu notifs_dropdown">
		<section id="gamification_notif_wrapper" class="notifs_panel">
			...
			<h4 style="margin-left:10px">
				<span class="label label-default">{l s='Level' mod='marketplace'} {$current_level|intval} : {$current_level_percent|intval} %</span>
			</h4>
			<div class="progress" style="margin: 10px">
				...
				<span class="sr-only">{l s='Level' mod='marketplace'} {$current_level|intval} : {$current_level_percent|intval} %</span>
				</div>
			</div>
			...
			<footer class="panel-footer">
				<a href="{$link->getAdminLink('AdminGamification')|escape:'html':'UTF-8'}">{l s='View my complete profile' mod='marketplace'}</a>
			</footer>
		</section>
	</div>
</li>