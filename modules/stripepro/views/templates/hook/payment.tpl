...
<script>
  ...
  var handler = StripeCheckout.configure({
    ...
    key: '{$stripe_pk}',
    image: 'http{if Tools::usingSecureMode()}s{/if}://{$smarty.server.SERVER_NAME}/img/payment-64x64.png',
	  currency:'{$currency}',
	  email:'{$cu_email}',
