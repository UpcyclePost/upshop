<div class="form-group">
	<label class="control-label" for="meta_title">{l s='Meta Title : (128 characters max)' mod='mpproductseo'}</label> {l s='Optional - Product name will be used if not provided' mod='mpproductseo'}
...
<div class="form-group">
	<label class="control-label" for="meta_desc">{l s='Meta Description : (128 characters max)' mod='mpproductseo'}</label> {l s='Optional - Short description will be used if not provided' mod='mpproductseo'}
