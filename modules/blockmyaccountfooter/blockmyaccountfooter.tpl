...
<div class="block myaccount">
	...
	<div class="block_content">
		<ul class="bullet">
			<li><a href="{$link->getPageLink('history', true)|escape:'html'}" title="{l s='My orders placed' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My orders placed' mod='blockmyaccountfooter'}</a></li>
