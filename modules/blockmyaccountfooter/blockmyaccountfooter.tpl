...
<div class="block myaccount">
	...
	<div class="block_content">
		<ul class="bullet">
			<li><a href="{$link->getPageLink('history', true)|escape:'html'}" title="{l s='My Purchases' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My Purchases' mod='blockmyaccountfooter'}</a></li>
